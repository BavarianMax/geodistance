...
def haversine_distance(lat1, lon1, lat2, lon2):
    """Gibt ma die Distanz zwischen zoa Lat/Lon-Punkten in Metern."""
...
def mgrs_distance(cmgrs1: str, cmgrs2: str):
    """Gibt ma an Abstand zwischen zwoa MGRS-Punkten in Zentimetern."""
...
if __name__ == "__main__":
    print("Abstand zwischen zwoa MGRS-Koordinaten (Genauigkeit bis auf Zentimeter)\n")
    while True:
        ...
        try:
            ...
            print(f"Da Abstand is: {dist_cm:.0f} Zentimeter ({dist_cm/100:.2f} Meter)")
        print("\n--- Nei starten oder STRG+C zum Beenden ---\n")
